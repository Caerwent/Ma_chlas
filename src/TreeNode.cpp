...
static void append_element(QQmlListProperty<TreeNode> *property, TreeNode *value)
{
...
static qsizetype count_element(QQmlListProperty<TreeNode> *property)
{
    TreeNode *parent = (qobject_cast<TreeNode *>(property->object));
    return parent->count();
}

static TreeNode *at_element(QQmlListProperty<TreeNode> *property, qsizetype index)
{
    TreeNode *parent = (qobject_cast<TreeNode *>(property->object));
...
static void clear_element(QQmlListProperty<TreeNode> *property)
{
    TreeNode *parent = (qobject_cast<TreeNode *>(property->object));
    parent->clear();
}
...
QQmlListProperty<TreeNode> TreeNode::nodes()
{
   ...
   return QQmlListProperty<TreeNode>(this,
                                             nullptr,
                                      &append_element,
                                      &count_element,
                                      &at_element,
