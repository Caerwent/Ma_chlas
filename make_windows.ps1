...
echo "============================================="
echo launch windeployqt
Start-Process -FilePath "$env:QT_DIR\bin\windeployqt" -ArgumentList "--release --qmldir $env:PROJECT_PATH\qml --qmake $env:QT_DIR\bin\qmake.exe  --verbose 2 release\Atalierou.exe" -Verbose -NoNewWindow -Wait
